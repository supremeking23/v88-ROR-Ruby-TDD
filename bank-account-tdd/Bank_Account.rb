class BankAccount
    ...
    attr_reader :account_number,:savings_account_balance,:checking_account_balance, :number_of_account, :interest_rate, :withd, :total_account
    ...
    def initialize
        ...
        @total_account =  @@number_of_account
    end
